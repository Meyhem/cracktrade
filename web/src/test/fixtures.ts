...
export const testMeta: EngineMeta = {
  ...
  defaults: {
    backtest: { objective: 'calmar', epochs: 0, folds: null, scheme: null, cache: null },
    optimize: { objective: 'calmar', epochs: 10, folds: null, scheme: null, cache: true },
    walk_forward: {
      objective: 'calmar',
      epochs: 10,
      folds: 6,
  ...
  exit_fields: [
    { name: 'signal', stop_priority: null },
    { name: 'atr_stop_multiplier', stop_priority: 1 },
    { name: 'trailing_stop_pct', stop_priority: 2 },
    { name: 'stop_loss_pct', stop_priority: 3 },
    { name: 'take_profit_pct', stop_priority: null },
    { name: 'min_holding_days', stop_priority: null },
    { name: 'max_holding_days', stop_priority: null },
  ],
  limits: [
